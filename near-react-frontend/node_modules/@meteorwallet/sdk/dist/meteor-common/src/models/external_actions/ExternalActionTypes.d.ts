...
export interface IOWalletExternalAction_SignIn_Output {
    accessKey: KeyPair;
    accountId: string;
}
...
export interface IOWalletExternalAccount_PostMessage_SignIn_Output {
    accountId: string;
    allKeys: string[];
}
export interface IOWalletExternalAccount_PostMessage_SignTransactions_Input {
    transactions: string;
}
...
export interface IOWalletExternalAccount_PostMessage_SignTransactions_Output {
...
export declare type TMeteorWalletExternalAction = IMeteorWalletExternalAction_Login | IMeteorWalletExternalAction_SignTransaction | IMeteorWalletExternalAction_Logout;
