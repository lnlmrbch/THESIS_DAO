import { Account, Connection, keyStores, Near, transactions, utils } from "near-api-js";
import { IMeteorActionResponse_Output, IOMeteorWalletSdk_RequestSignIn_Inputs, IOMeteorWalletSdkAccount_SignAndSendTransaction_Input, IORequestSignTransactions_Inputs, IOWalletExternalAction_SignIn_Output, IOWalletExternalLinkedContract } from "../../meteor-common/src/models/external_actions/ExternalActionTypes";
...
export declare class MeteorWallet {
     ...
     * */
    requestSignIn(options: IOMeteorWalletSdk_RequestSignIn_Inputs): Promise<IMeteorActionResponse_Output<IOWalletExternalAction_SignIn_Output>>;
    /**
...
export declare class ConnectedMeteorWalletAccount extends Account {
     ...
     */
    accessKeyMatchesTransaction(accessKey: any, receiverId: string, actions: transactions.Action[]): Promise<boolean>;
    /**
     ...
     * @returns Promise<any>
     */
    accessKeyForTransaction(receiverId: string, actions: transactions.Action[], localKey?: utils.PublicKey): Promise<any>;
}
export {};
